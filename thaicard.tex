...
\newfontfamily\cyrillicfont{Path=./fonts/,Tahoma Bold}[Script=Cyrillic]
\newfontfamily\thaifont{Sathu}[Path=./fonts/,Script=Thai,Scale=MatchLowercase,WordSpace=1.25,Mapping=tex-text]
\usepackage{xunicode}
\usepackage{xltxtra}
\pagestyle{empty}
\begin{document}
